from errors import logicErrors  # import obslugi wyjatkow
...
class Thing:
    """Klasa definiujaca wszelkie przedmioty

    argumenty:
    name - nazwa rzeczy
    count - liczba sztuk danej rzeczy"""
    ...
    def get_count(self):
        """Metoda zwracajaca liczbe sztuk danego przedmiotu"""
        return self._count

    def lower_count(self):
        """Metoda zmniejszajaca ilosc tej rzeczy o 1 sztuke"""
        self._count -= 1

    def check_item_count(self):
        """Metoda sprawdzajaca czy liczba tych rzeczy jest wieksza od 0. Zwraca wartosc True gdy rzecz jest na stanie, w przeciwnym
...
class Storage:
    """Klasa bedaca kontenerem na przedmioty takie jak monety, towary
        ...
        Towary przechowywane sa w liscie."""

    def __init__(self):
        # lista przechowujaca towary, monety
        self._item_list = []

    def add_item(self, added_item, required_class):
        ...
        try:
            ...
            if isinstance(added_item, required_class):
                self._item_list.append(added_item)
            else:
                raise logicErrors.InvalidObjectTypeError(
                    "Przeslany obiekt nie jest obiektem klasy " + required_class + "! Jest on typu ",
                    type(added_item))
...
class Item(Thing):
    ...
    def __init__(self, name, number, price, count):
        ...
        self._number = number
        self._price = helpers.decimal_2places_rounded(price)
    ...
    def get_price(self):
        ...
        return helpers.decimal_2places_rounded(self._price)
...
class Coin:
    ...
    def __init__(self, value):
        ...
        self._value = helpers.decimal_2places_rounded(value)
    ...
    def get_value(self):
        ...
        return helpers.decimal_2places_rounded(self._value)
...
class CoinStorage(Storage):
    ...
    def add_multiple_coins(self, coin_value, coin_count):
        ...
        for coin in range(coin_count):
            self._item_list.append(Coin(coin_value))
    ...
    def get_coin_index(self, chosen_coin_value):
        ...
        return next(i for i, coin in enumerate(self._item_list) if coin.get_value() == chosen_coin_value)
    ...
    def return_array_of_value(self):
        ...
        value_list = [float(o.get_value()) for o in self._item_list]
        return value_list
    ...
    def return_rest(self, rest_coin_value, rest_coin_count):
        ...
        for rcount in range(rest_coin_count):
            ...
            rest_coin_txt += "Wydaje reszte o wartosci " + str(
                self._item_list.pop(selected_coin_index).get_value()) + "zl.\n"
    ...
    def take_money_inside(self, customer_money):
        ...
        while customer_money.return_len():
            self._item_list.append(customer_money.pop_coin_object())
    ...
    def coin_sum(self):
        ...
        return sum(c.get_value() for c in self._item_list)
        ...
        try:
            ...
            if selected_item_count:
                ...
                if rest == 0:
                    ...
                    returned_change_dict_list = helpers.return_change(counted_rest_coins_list,
                                                                      int(rest * 100))  # licz reszte
                    if returned_change_dict_list is None:  # jezeli nie udalo sie obliczyc reszty zglos wyjatek
                        ...
                        for rc in returned_change_dict_list:  # dla wszystkich slownikow reszty (nominal, ilosc)
                            ...
                            change_txt += machine_rest_coins.return_rest(*helpers.unpack_dict(**rc))
